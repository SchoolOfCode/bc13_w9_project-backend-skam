 ...
 */
export async function getUsersByFilter(programminglang, location, spokenlang) {
	let sqlStatement = `SELECT * FROM users JOIN locations ON users.location = locations.value `;
	let sqlParams = [];
